...
echo_and_run cd "/home/xj/Documents/catkin_ws/src/robotiq/robotiq_modbus_tcp"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/xj/Documents/catkin_ws/src/robotiq/robotiq_modbus_tcp/setup.py" \
     \
    build --build-base "/home/xj/Documents/catkin_ws/src/robotiq/robotiq_modbus_tcp" \
    install \
    --root="${DESTDIR-/}" \
