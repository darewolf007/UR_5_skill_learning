...
def handle_add_two_ints(req):
    ...
    # from my_ddt_hybrid_image_policy import  MyDDTHybridImagePolicy
    from my_diffusion_unet_hybrid_image_policy import MyDiffusionUnetHybridImagePolicy
    ...
    checkpoint = '/home/yhx/diffusion_policy/data/ddt_edge/latest.ckpt' # hunhe
    ...
    # #实例化policy
    yaml_file_path = "/home/yhx/diffusion_policy/my_test_ddt.yaml"
    ...
    images = images[92:1344,50:1302] # shujia
    ...
    a = policy.predict_action(obs_input_dict, np.array([0,0]))
    # print(a)
    end_time = time.time()
    ...
    # for i in range(1):
        ...
        # delta_rpy[0] = delta_rpy[2] = 0
        # # delta_rpy[1] = min(delta_rpy[1], 0) # step 1
        
        # delta_rpy[1] = -0.01 # step 2
        # delta_pos[2] = delta_pos[2] *2
        # delta_pos[1] = 0
        
        
        # if current_pos[0] > 0.47:
        #     delta_rpy = np.array([0, 0, 0])
        # delta_rpy = delta_rpy / 5
        # delta_pos[0] = 0.008
        # if current_pos[0] > 0.540 and current_pos[0]<0.55 and current_pos[2]<0.453:
        #     assert 1==2
        ...
        current_rpy = current_rpy + delta_rpy
        # if current_pos[0] > 0.48:
        #     current_pos[2] = max(0.398, current_pos[2])


        current_quat = euler_to_quaternion(current_rpy)
        # current_quat = [ 0.48305969,  0.54646683 ,-0.50490427 , 0.40627708]
