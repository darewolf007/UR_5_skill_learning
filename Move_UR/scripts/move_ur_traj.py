...
class TrajectoryClient:
    ...
    def move_once_by_joint(self, joint_position):
        self.switch_controller(self.joint_trajectory_controller)
        trajectory_client = actionlib.SimpleActionClient(
            "{}/follow_joint_trajectory".format(self.joint_trajectory_controller),
            FollowJointTrajectoryAction,
...
class shw_ur_auto_collect:
    ...
    def shw_end_traj_move(self):
        end_position1 = [ -0.206992924455, -0.578936818643, 0.195838372629, -0.0233070786438, -0.99939292491, -0.0180450417058, 0.0185725118253]
        end_position2 = [-0.206991188991, -0.578940572239, 0.0716936458811, -0.0233230925389, -0.999392838978, -0.0180389129846, 0.0185629839498]
        end_position3 = [-0.20700119726, -0.641233103889, 0.0717359339521, -0.0233226724054, -0.999393053353, -0.0179992879558, 0.0185904140367]
        end_position4 = [-0.0998959010988, -0.641210695104, 0.0717140811463, -0.0233168900578, -0.999392567244, -0.0180238577497, 0.0185999926532]
        end_position5 = [-0.09991263381, -0.516755156918, 0.0717003860638, -0.0233413707661, -0.999391792864, -0.0180392044889, 0.0185960175454]
        end_position5_1 = [-0.0998775515271, -0.530433449629, 0.0716401283034, -0.0232925413361, -0.999392380754, -0.0181039222172, 0.0185627263313]
        end_position6 = [-0.0998838243869, -0.516728602821, 0.156206355017,  -0.0233066130699, -0.999392522828,  -0.0180798482429, 0.0185608779277]
        end_position7 = [-0.00648704385, -0.635758311955, 0.156234591449,  -0.0233307172244, -0.999392618697, -0.0180355201154, 0.0185685578787]
        end_position8 = [-0.00654007907002, -0.643780357407, 0.117624929982, -0.0233319170712, -0.99939205311, -0.0180465275747, 0.0185867874801]
        end_position9 = [-0.00652495655719, -0.643757624262, 0.193404205376, -0.023330213161, -0.999391427116, -0.0180661378935, 0.0186035271757]
        end_position10 = [0.14687754329, -0.641263574685, 0.193443435189, -0.0235856263186, -0.9995432427, -0.00474075782972, 0.0182906921608]
        end_position11 = [0.146877710209, -0.641253247183, 0.144769143385, -0.0235860662888, -0.999543434216, -0.00476913763771, 0.0182722718409]
        end_position12 = [0.138062452332,  -0.641246397819, 0.0871108380974, -0.0235636016087, -0.999543786525, -0.00477654649921, 0.0182800465413]
        end_position13 = [0.138046127537, -0.641270231043, 0.180231794064, -0.0235812591532, -0.999543413749, -0.00475381715455, 0.0182835847198]
        end_position14 = [0.340197190592, -0.641253071988, 0.180205213314, -0.0235820282926, -0.999542986058, -0.00479392217152, 0.018295498722]
        end_position15 = [0.340220117798, -0.641236669639, 0.240721921033, -0.0235595648436, -0.999543849053, -0.00477777639142, 0.0182815091761]
        end_position16 = [0.148797377347, -0.641256149283, 0.240741409963, -0.0235455029645, -0.999544339982, -0.00476253226278, 0.0182767608072]
