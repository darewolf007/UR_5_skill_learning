...
class TrajectoryClient:
    ...
    def send_cartesian_trajectory(self):
        ...
        pose_list = [
            geometry_msgs.Pose(
                geometry_msgs.Vector3(0.7+0.05*(numpy.random.random()-0.5), -0.133+0.05*(numpy.random.random()-0.5), 0.258+0.05*(numpy.random.random()-0.5)), geometry_msgs.Quaternion(0,1,0,0) #(0100) push to wall
                # geometry_msgs.Vector3(0.63-0.06, -0.133, 0.458), geometry_msgs.Quaternion(0.707, -0.707,0,0)
                # geometry_msgs.Vector3(0.5, -0.133, 0.358), geometry_msgs.Quaternion(0.707, -0.707,0,0)
            
                # geometry_msgs.Vector3(0.5, -0.134, 0.358), geometry_msgs.Quaternion(0, 1,0,0) # yuan gouxing_1
                # geometry_msgs.Vector3(0.47, -0.133, 0.358), geometry_msgs.Quaternion(0, 1,0,0) # orange box push
                # geometry_msgs.Vector3(0.45, -0.133, 0.358), geometry_msgs.Quaternion(0, 1,0,0) # wooden block
                # geometry_msgs.Vector3(0.5-0.11, -0.133+0.39, 0.358), geometry_msgs.Quaternion(0.707, -0.707,0,0)
